...
//koneksi ke database
 ...
 <section class="riwayat">
 				...
 				while($pecah=$ambil->fetch_assoc()){
 					...
 					<td>
 						...
 						<?php if ($pecah["status_pembelian"]=="Belum Dibayar"): ?>
 							...
 							<?php else: ?>
 								<a href="lihat_pembayaran.php?id=<?php echo $pecah["id_pembelian"]; ?>" class="btn btn-warning green">
 									lihat pembayaran
 								</a>
 						<?php endif ?>
 					</td>
 	...
 	<hr> <br> <br><br>
 	<a class="waves-effect waves-light teal btn right green"href="index.php"> Kembali</a> <br> <br> <br>
 </div>
</section>
<!-- footer -->
