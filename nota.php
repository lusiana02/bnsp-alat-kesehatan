...
<head>
	...
	<link rel="shortcut icon" type="text/css" href="logo-tokoalkes.png"/>
...
<body>
	...
	<section class="konten">
		<div class="container">
			...
			<div class="row">
				<div class="col s12">
					<div class="card-panel green hoverable">
		...
		<a href="download_nota.php?id=<?php echo $detail['id_pembelian']; ?>" target="_blank" class="waves-effect waves-light right btn green">
    		<i class="material-icons left">file_download</i>Download Nota
		</a>
		<a href="riwayat.php" class="waves-effect waves-light btn green">Kembali</a>
		<br><br><br>
	</div>		
</section>
