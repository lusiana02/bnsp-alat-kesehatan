...
<body>
	...
	<section class="konten">
		<div class="container">
			...
			<br>
			<a href="index.php" class="waves-effect waves-light btn green" style="margin-right: 10px;">Lanjutkan Belanja</a>
			<a href="checkout.php" class="waves-effect waves-light btn green">Checkout</a>
		</div>
		<br><br><br><br><br>
